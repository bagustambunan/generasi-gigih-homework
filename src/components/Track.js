...
const Track = props => {
    ...
    return (
        <div className="bg-gray-600 px-5 py-5 rounded-lg w-1/5 mr-2">
            ...
            <button className="w-full py-1 rounded mt-2 bg-gray-700 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 text-white"
