        ...
        <div className="inline-block align-bottom bg-me_card rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  className="text-lg leading-6 font-medium text-me_dark_half mb-5"
                  id="modal-title"
                >
          ...
          <div className="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button
              ...
              type="button"
              className="w-full inline-flex justify-center rounded-md border border-transparent px-4 py-2 bg-me_primary hover:bg-gray-600 text-base font-medium text-white sm:ml-3 sm:w-auto sm:text-sm"
            >
              Done
            </button>
            <button
              ...
              type="button"
              className="mt-3 w-full inline-flex justify-center rounded-md border-2 border-gray-400 px-4 py-2 text-base font-medium text-gray-400 hover:border-me_primary hover:text-me_primary sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
            >
              Cancel
            </button>
          </div>
